					...
					<sf:form id="form" method="post" action="" modelAttribute="computerDTO">
						<fieldset>
							...
							<div class="form-group">
								...
								<spring:message code="placeholder.computer.introduced" var="introducedPlaceholder" />
								<c:set var="introduced"><mylib:date date="${ computerDTO.introduced }"></mylib:date></c:set>
								<sf:input id="introduced" path="introduced" class="form-control datepicker" placeholder="${ introducedPlaceholder }" value="${ introduced }" />
							...
							<div class="form-group">
								...
								<spring:message code="placeholder.computer.discontinued" var="discontinuedPlaceholder" />
								<c:set var="discontinued"><mylib:date date="${ computerDTO.discontinued }"></mylib:date></c:set>
								<sf:input id="discontinued" path="discontinued" class="form-control datepicker" placeholder="${ discontinuedPlaceholder }" value="${ discontinued }" />
